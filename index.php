...
<!-- signup form -->
<hr>
<div class="row py-4 text-muted text-center">
    <div class="col-md col-xl-5">
        <p><strong>About Swop Match Handler</strong></p>
        <p class="font-weight-bold">SwopMatch Handler brings affordable technology to people everywhere to help them achieve their dreams and change the Nation.</p>
    </div>
    <div class="col-md col-xl-5 ml-auto">
        <p><strong>signup for updates on Swop Match Handler</strong></p>
