...
include 'class_lib.php';
      ...
      echo 'Reserving matched preferred schools 9th option'.'<br>';
      
      $schools_opt9->update_table('match_pref_schools9', 'mps9_status', 'mps9_client_ec_no');
      echo "Updating records completed sucessfully!".'<br>';
      
      echo '<h4>Reserving current schools matched with preferred schools 9th option'.'<br>';
      
      $schools_opt9->update_table('match_current_schools', 'mcs_status', 'mcs_client_ec_no');
      echo "Updating records completed sucessfully!".'<br>';
      
      echo 'Reserving clients matched with preferred schools 9th option'.'<br>';
      
      $schools_opt9->update_clients();
      echo "Updating records completed sucessfully!".'<br>';
      
      echo 'Deactivating other options in other tables for matches found'.'<br>';
      
      $schools_opt9->deactivate_other_options();
